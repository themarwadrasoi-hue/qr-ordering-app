...
export const menuItems = [
    ...
    { id: 139, menuType: ['cafe'], category: 'burgers', title: 'egg burger', desc: 'Classic burger with a fried egg.', price: 110, isAvailable: true, image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=500&q=60' },
    { id: 140, menuType: ['cafe'], category: 'burgers', title: 'double tiki burger', desc: 'Double patty burger for extra hunger.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1586816001966-79b736744398?auto=format&fit=crop&w=500&q=60' },

    // CAFE - SANDWICH
    { id: 103, menuType: ['cafe'], category: 'sandwich', title: 'Grilled sandwich', desc: 'Veg grilled sandwich.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&w=500&q=60' },
    { id: 104, menuType: ['cafe'], category: 'sandwich', title: 'cheese corn sandwich', desc: 'Sweet corn and melted cheese.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1550507992-eb63ffee0847?auto=format&fit=crop&w=500&q=60' },
    { id: 133, menuType: ['cafe'], category: 'sandwich', title: 'chese garlic bread', desc: 'Garlic bread with melted cheese.', price: 150, isAvailable: true, image: 'https://images.unsplash.com/photo-1573140247632-f8fd74997d5c?auto=format&fit=crop&w=500&q=60' },
    { id: 134, menuType: ['cafe'], category: 'sandwich', title: 'periperi sandwich', desc: 'Spicy peri peri flavored sandwich.', price: 80, isAvailable: true, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&w=500&q=60' },
    { id: 135, menuType: ['cafe'], category: 'sandwich', title: 'Plain Sandwich', desc: 'Simple veg sandwich.', price: 100, isAvailable: true, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&w=500&q=60' },
    { id: 136, menuType: ['cafe'], category: 'sandwich', title: 'Paneer grilled sandwich', desc: 'Grilled sandwich with spicy paneer.', price: 160, isAvailable: true, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&w=500&q=60' },
    { id: 137, menuType: ['cafe'], category: 'sandwich', title: 'egg Sandwich', desc: 'Classic egg sandwich.', price: 120, isAvailable: true, image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?auto=format&fit=crop&w=500&q=60' },

    // CAFE - PIZZA
    { id: 105, menuType: ['cafe'], category: 'pizza', title: 'Margherita Pizza', desc: 'Classic cheese and tomato sauce.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1574071318508-1cdbad80ad50?auto=format&fit=crop&w=500&q=60' },
    { id: 106, menuType: ['cafe'], category: 'pizza', title: 'Farmhouse Pizza', desc: 'Topped with capsicum, onion, and corn.', price: 230, isAvailable: true, image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=500&q=60' },

    // CAFE - PASTA
    { id: 107, menuType: ['cafe'], category: 'pasta', title: 'White Pasta', desc: 'Penne in creamy alfredo sauce.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1645112481338-3c353986427a?auto=format&fit=crop&w=500&q=60' },
    { id: 108, menuType: ['cafe'], category: 'pasta', title: 'Red Pasta', desc: 'Penne in spicy arabiata sauce.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&w=500&q=60' },

    // CAFE - MAGGIE
    { id: 109, menuType: ['cafe'], category: 'maggie', title: 'Plain maggie', desc: 'Classic simple maggie.', price: 70, isAvailable: true, image: 'https://images.unsplash.com/photo-1612927653241-cd47b198f1f5?auto=format&fit=crop&w=500&q=60' },
    { id: 110, menuType: ['cafe'], category: 'maggie', title: 'Peri peri maggie', desc: 'Spicy peri peri flavored noodles.', price: 120, isAvailable: true, image: 'https://images.unsplash.com/photo-1612927653241-cd47b198f1f5?auto=format&fit=crop&w=500&q=60' },
    { id: 130, menuType: ['cafe'], category: 'maggie', title: 'Masala maggie', desc: 'Classic spicy masala maggie.', price: 120, isAvailable: true, image: 'https://images.unsplash.com/photo-1612927653241-cd47b198f1f5?auto=format&fit=crop&w=500&q=60' },
    { id: 131, menuType: ['cafe'], category: 'maggie', title: 'Vegitable maggie', desc: 'Maggie with mixed vegetables.', price: 110, isAvailable: true, image: 'https://images.unsplash.com/photo-1612927653241-cd47b198f1f5?auto=format&fit=crop&w=500&q=60' },
    { id: 132, menuType: ['cafe'], category: 'maggie', title: 'Maggie with cheese', desc: 'Cheese loaded noodles.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1612927653241-cd47b198f1f5?auto=format&fit=crop&w=500&q=60' },

    // CAFE - COFFEE & TEA
    { id: 111, menuType: ['cafe'], category: 'coffee_tea', title: 'Coffee hot', desc: 'Classic milk coffee.', price: 50, isAvailable: true, image: 'https://images.unsplash.com/photo-1541167760496-162955ed8a9f?auto=format&fit=crop&w=500&q=60' },
    { id: 112, menuType: ['cafe'], category: 'coffee_tea', title: 'Tea + Toast', desc: 'Masala tea with buttered toast.', price: 40, isAvailable: true, image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=500&q=60' },
    { id: 113, menuType: ['cafe'], category: 'coffee_tea', title: 'Cold coffee', desc: 'Chilled blended coffee.', price: 80, isAvailable: true, image: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?auto=format&fit=crop&w=500&q=60' },
    { id: 123, menuType: ['cafe'], category: 'coffee_tea', title: 'Lemon tea', desc: 'Refreshing lemon tea.', price: 30, isAvailable: true, image: 'https://images.unsplash.com/photo-1544787210-22ed1303837e?auto=format&fit=crop&w=500&q=60' },
    { id: 124, menuType: ['cafe'], category: 'coffee_tea', title: 'Ginger honey tea', desc: 'Ginger and honey infused tea.', price: 50, isAvailable: true, image: 'https://images.unsplash.com/photo-1544787210-22ed1303837e?auto=format&fit=crop&w=500&q=60' },

    // CAFE - FRIES & SIDES
    { id: 114, menuType: ['cafe'], category: 'fries_sides', title: 'french fries', desc: 'Classic salted potato fries.', price: 100, isAvailable: true, image: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=500&q=60' },
    { id: 115, menuType: ['cafe'], category: 'fries_sides', title: 'peri peri fries', desc: 'Fries with spicy peri peri seasoning.', price: 130, isAvailable: true, image: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=500&q=60' },
    { id: 138, menuType: ['cafe'], category: 'fries_sides', title: 'cheese fries', desc: 'Fries topped with melted cheese sauce.', price: 160, isAvailable: true, image: 'https://images.unsplash.com/photo-1585109649139-366815a0d713?auto=format&fit=crop&w=500&q=60' },

    // CAFE - ROLLS
    { id: 141, menuType: ['cafe'], category: 'rolls', title: 'chicken roll', desc: 'Spiced chicken wrapped in a flatbread.', price: 100, isAvailable: true, image: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?auto=format&fit=crop&w=500&q=60' },
    { id: 142, menuType: ['cafe'], category: 'rolls', title: 'egg roll', desc: 'Egg omelette wrap.', price: 80, isAvailable: true, image: 'https://images.unsplash.com/photo-1606491956689-2ea8c5119c81?auto=format&fit=crop&w=500&q=60' },
    { id: 143, menuType: ['cafe'], category: 'rolls', title: 'veg roll', desc: 'Mixed vegetable wrap.', price: 60, isAvailable: true, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=500&q=60' },
    { id: 144, menuType: ['cafe'], category: 'rolls', title: 'veg paneer roll', desc: 'Grilled paneer wrap with spice.', price: 120, isAvailable: true, image: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?auto=format&fit=crop&w=500&q=60' },
    { id: 145, menuType: ['cafe'], category: 'rolls', title: 'cheese corn roll', desc: 'Melted cheese and corn wrap.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1606491956689-2ea8c5119c81?auto=format&fit=crop&w=500&q=60' },
    { id: 116, menuType: ['cafe'], category: 'rolls', title: 'spring roll', desc: 'Crispy fried vegetable rolls (2 Pcs).', price: 50, isAvailable: true, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=500&q=60' },

    // CAFE - NOODLES
    { id: 146, menuType: ['cafe'], category: 'noodles', title: 'hakka noodels', desc: 'Classic hakka style noodles.', price: 130, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 147, menuType: ['cafe'], category: 'noodles', title: 'veg chowmine', desc: 'Stir fried vegetable chowmine.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 148, menuType: ['cafe'], category: 'noodles', title: 'shejwan noodel', desc: 'Spicy schezwan noodles.', price: 150, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 149, menuType: ['cafe'], category: 'noodles', title: 'veg paneer noodels', desc: 'Noodles with fresh paneer cubes.', price: 170, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 150, menuType: ['cafe'], category: 'noodles', title: 'egg noodels', desc: 'Noodles with scrambled eggs.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 151, menuType: ['cafe'], category: 'noodles', title: 'chicken noodels', desc: 'Noodles with shredded chicken.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },

    // CAFE - PAKODA
    { id: 152, menuType: ['cafe'], category: 'pakoda', title: 'paneer pakode', desc: 'Deep fried cottage cheese fritters.', price: 200, isAvailable: true, image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=500&q=60' },
    { id: 153, menuType: ['cafe'], category: 'pakoda', title: 'veg pakode', desc: 'Mixed vegetable deep fried fritters.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=500&q=60' },
    { id: 154, menuType: ['cafe'], category: 'pakoda', title: 'egg pakode', desc: 'Deep fried egg fritters.', price: 180, isAvailable: true, image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=500&q=60' },

    // CAFE - CHINESE
    { id: 117, menuType: ['cafe'], category: 'chinese_cafe', title: 'Veg Manchurian', desc: 'Savoury veg balls in glaze.', price: 160, isAvailable: true, image: 'https://images.unsplash.com/photo-1512058560366-cd2427ff667d?auto=format&fit=crop&w=500&q=60' },
    { id: 118, menuType: ['cafe'], category: 'chinese_cafe', title: 'Veg Chowmein', desc: 'Classic stir-fried noodles.', price: 120, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },
    { id: 119, menuType: ['cafe'], category: 'chinese_cafe', title: 'Hakka Noodles', desc: 'Mildly spiced chinese noodles.', price: 140, isAvailable: true, image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=500&q=60' },

    // CAFE - SPECIALS
    { id: 120, menuType: ['cafe'], category: 'paneer_tikka_cafe', title: 'Paneer Tikka', desc: 'Grilled marinated cottage cheese.', price: 230, isAvailable: true, image: 'https://images.unsplash.com/photo-1567188040759-fb8ad883dc6d?auto=format&fit=crop&w=500&q=60' },

    // CAFE - DRINKS
    { id: 125, menuType: ['cafe'], category: 'drinks', title: 'Coke', desc: '300ml chilled can/bottle.', price: 35, isAvailable: true, image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?auto=format&fit=crop&w=500&q=60' },
    { id: 126, menuType: ['cafe'], category: 'drinks', title: 'Thumps up', desc: '300ml chilled can/bottle.', price: 35, isAvailable: true, image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=500&q=60' },
    { id: 127, menuType: ['cafe'], category: 'drinks', title: 'Dew', desc: '300ml chilled can/bottle.', price: 35, isAvailable: true, image: 'https://images.unsplash.com/photo-1541491008689-b5d3c6615e8e?auto=format&fit=crop&w=500&q=60' },
    { id: 128, menuType: ['cafe'], category: 'drinks', title: 'Sprite', desc: '300ml chilled can/bottle.', price: 35, isAvailable: true, image: 'https://images.unsplash.com/photo-1625772290748-39126cdd9fe9?auto=format&fit=crop&w=500&q=60' },
    { id: 129, menuType: ['cafe'], category: 'drinks', title: 'Fanta', desc: '300ml chilled can/bottle.', price: 35, isAvailable: true, image: 'https://images.unsplash.com/photo-1624517452488-04869289c4ca?auto=format&fit=crop&w=500&q=60' },
    { id: 122, menuType: ['cafe'], category: 'drinks', title: 'Lassi', desc: 'Thick sweet curd drink.', price: 60, isAvailable: true, image: 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=500&q=60' },
    ...
    { id: 190, menuType: ['cafe', 'hut'], category: 'mains_egg_fish', title: 'Egg Curry', desc: 'Spiced egg curry with aromatic gravy.', price: 150, isAvailable: true, variants: { half: 150, full: 280 }, image: 'https://images.unsplash.com/photo-1541832676-9b763b0239ab?auto=format&fit=crop&w=500&q=60' },
